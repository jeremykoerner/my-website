...
author:  "[Jeremy Koerner](https://github.com/jeremykoerner), 22/02/21"
output:
  html_document:
    fig_width: 1
---
...
------------------------------------------------------------------------
Thank you Julia Lowndes for the Tutorial!  

*Did this Italicize?*

**Did this Bold?**  

~~How about a strikethrough and superscript^2^ combo?~~
...
2.  create a [GitHub]((http://github.com)) account ([advice](http://happygitwithr.com/github-acct.html))
